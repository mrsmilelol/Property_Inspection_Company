...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $shoppingSession->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $shoppingSession->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="shoppingSessions form content">
            ...
            <fieldset>
                <legend><?= __('Edit Shopping Session') ?></legend>
                <?php
