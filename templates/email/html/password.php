                    ...
                    <tr>
                        <td class="wrapper">
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <p>Hi, please click the link below to reset your password.</p>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <table role="presentation" border="0" cellpadding="0"
                                                        ...
                                                        <tbody>
                                                        <tr>
                                                            <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'edit_password', 'prefix' => false, $token], ['fullBase' => true]); ?>">Reset
                                                                password</a>
                                                        </tr>
                                                        </tbody>
                                                    </table>
