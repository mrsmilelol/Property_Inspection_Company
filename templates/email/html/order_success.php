                        ...
                        <td class="wrapper">
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <p>Hi <?= h($firstname . ',') ?></p>
                                        <p>Your wholesale account application for Chelsea Fine Furnishings has been
                                            approved - </p>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <table role="presentation" border="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'login', 'prefix' => false], ['fullBase' => true]); ?>">Please
                                                                    click to proceed to the login page</a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
