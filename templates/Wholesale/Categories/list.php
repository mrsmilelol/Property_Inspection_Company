            ...
            <div class="col-xs-12 col-sm-3">
                ...
                <div class="left-widget-content  indicator-banner">
                    ...
                    <form action="/team09-app_fit3048/products/shop">
                        ...
                        <button type="submit" class="btn btn-primary single-shop-form" style="background-color: #c38748; border-radius: 0px; border: 0; width: 100%; text-transform: uppercase">Search</button>
                    </form>
                </div>
            </div>
