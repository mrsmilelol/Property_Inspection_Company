        ...
        <div class="row-dashboard mb-n30">
            ...
            <div class="col-12 mb-30" style="flex: 0 0 auto; width: 25%;">
                <div class="myaccount-tab-menu nav-dashboard" role="tablist" id="allTabs">
                    ...
                    <a href="#account-info" class="aTab" data-toggle="tab"><i class="fa fa-user"></i> Account
                        Details</a>
                </div>
            </div>
                ...
                <div class="tab-content" id="myaccountContent">
                    ...
                    <div class="tab-pane fade active in" id="dashboard" role="tabpanel">
                        <div class="myaccount-content">
                            <h5>Dashboard</h5>
                            <div class="welcome">
                                <p class="lhbigger">Hello,
                                    <strong><?= h($the_user->firstname) . ' ' . h($the_user->lastname) ?> </strong>
                                    <!--(If Not <strong>Tuntuni !</strong><a href="login-register.html" class="logout"> Logout</a>)-->
                                </p>
                            </div>
                            <br>
                            <p class="lhbigger mb-0">From your account dashboard, you can easily check &amp; view your
                                recent orders, manage your address and edit your account details.</p>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= $this->Url->build(['controller' => 'Orders', 'action' => 'view', $order->id]) ?>"
                                                   class="btn btn-round orders-btn-view">View</a>
                                                <?php if (strcmp($order->status, 'Order is placed') == 0) : ?>
                                                    <a href="<?= $this->Url->build(['controller' => 'CancelledOrders', 'action' => 'cancel', $order->id]) ?>"
                                                       class="btn btn-round orders-btn-view">Cancel</a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                            ...
                            <address>
                                <?php if (!empty($addresses)) : ?>
                                    <?php foreach ($addresses as $address) : ?>
                                        ...
                                        <a href="<?= $this->Url->build(['controller' => 'UserAddresses', 'action' => 'edit', $address->id]) ?>"
                                ...
                                <a href="<?= $this->Url->build(['controller' => 'UserAddresses', 'action' => 'add', $the_user->id]) ?>"
                                   class="btn btn-round d-inline-block address-btn-edit">
                    ...
                    <div class="tab-pane fade" id="account-info" role="tabpanel">
                        <div class="myaccount-content">
                            ...
                            <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'account', $the_user->id]) ?>"
                               class="btn btn-round d-inline-block address-btn-edit"><i
